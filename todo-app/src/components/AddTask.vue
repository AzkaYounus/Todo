...
export default {
  ...
  async fetchTasks() {
  try {
    const response = await axios.get('https://e106-110-39-38-126.ngrok-free.app/tasks', {
      headers: {
    ...
    async addTask() {
      ...
      try {
        ...
        const response = await axios.post('https://e106-110-39-38-126.ngrok-free.app/tasks', payload, headers);
    ...
    async updateTask() {
      ...
      try {
        ...
        const response = await axios.put(`https://e106-110-39-38-126.ngrok-free.app/tasks/${task.id}`, payload, headers);
        this.newtask[index] = {
          ...response.data,
          isEditing: false,
          updateCalender: false
    ...
    async deleteTask(index) {
      ...
      try {
        ...
        await axios.delete(`https://e106-110-39-38-126.ngrok-free.app/tasks/${task.id}`, headers);
    ...
    async deleteAll() {
      ...
      try {
        ...
        await axios.delete('https://e106-110-39-38-126.ngrok-free.app/delete-all', headers);
        this.newtask = [];
      } catch (error) {
...
async completeAll() {
  try {
    ...
    const response = await axios.put('https://e106-110-39-38-126.ngrok-free.app/complete-all', null, headers);
