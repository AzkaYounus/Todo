...
export default {
  ...
  async fetchTasks() {
  try {
    const response = await axios.get('https://d1f4-110-39-38-126.ngrok-free.app/api/tasks', {
      headers: {
    ...
    async addTask() {
      ...
      try {
        ...
        const response = await axios.post('http://localhost:8000/api/tasks', payload, headers);
    ...
    async updateTask() {
      ...
      try {
        ...
        const response = await axios.put(`http://localhost:8000/api/tasks/${task.id}`, payload, headers);
        this.newtask[index] = {
          ...response.data,
          isEditing: false,
          updateCalender: false
    ...
    async deleteTask(index) {
      ...
      try {
        ...
        await axios.delete(`http://localhost:8000/api/tasks/${task.id}`, headers);
    ...
    async deleteAll() {
      ...
      try {
        ...
        await axios.delete('http://localhost:8000/api/delete-all', headers);
        this.newtask = [];
      } catch (error) {
...
async completeAll() {
  try {
    ...
    const response = await axios.put('http://localhost:8000/api/complete-all', null, headers);
